 ...
 *
 * Mora em /api/public/* porque o middleware exclui esse prefixo de auth checks —
...
export async function GET(
  ...
  if (eventsErr) {
    console.error('[api/public/calendar/[token]] events query failed', { memberId: member.id, error: eventsErr.message });
