...
const MODAL_TITLE_ID = 'cancel-modal-title';
const MODAL_DESC_ID = 'cancel-modal-desc';

/**
 * Modal "Cancelar reunião com feedback" — abre ao clicar Cancelar reunião.
 *
 * Features:
 * - Textarea opcional para feedback (motivo do cancelamento)
      ...
      >
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <div>
              <label htmlFor="cancel-reason" className="block text-text-secondary text-xs font-medium mb-2 uppercase tracking-wider">
