 ...
 * quadrado cream da logo no fundo escuro. Composição em vez de mask-image,
 * pra funcionar 100% mesmo em imagens cross-origin.
 */
const EQR_LOGO_URL =
...
export function EqrLogo({
  ...
  return (
    <div className={cn('relative overflow-hidden', className)} style={{ opacity: 0.95 }}>
      {inner}
      {/* Overlay radial: transparente no centro, vai virando cor de fundo nas bordas */}
      <div
